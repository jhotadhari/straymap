...
const SCAN_DIRS = [
  'src/compose',
  'src/components',
  'src/store/features/lines',
  'src/store/features/routing',
  'src/store/features/drawers',
  'src/store/features/dashboard',
  'src/store/features/dirs',
  'src/store/features/appearance',
  'src/store/features/dbLoader',
  'src/store/features/general',
  'src/store/features/ui',
  'src/store/features/lang',
  'src/store/features/updater',
  'src/store/features',
  'src/store',
  'src/lib',
];
