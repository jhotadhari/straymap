...
import { selectShowSettingsHandle } from '../../drawers/selectors';
import { setShowSettingsHandle } from '../../drawers/slice';
import DrawerControlModal from '../../drawers/components/controls/DrawerControlModal';
...
const SettingsDrawers: FC<{ style?: ViewStyle }> = ({ style }) => {
	...
	const toggleLabel = useMemo(
		() =>
			showSettingsHandle
				? t('drawers.showSettingsHandle')
				: t('drawers.hideSettingsHandle'),
