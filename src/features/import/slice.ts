...
export const DATE_PATTERN_PRESETS: DatePattern[] = [
	{
		...
		label: 'ISO date with time (YYYY-MM-DD HH:MM:SS)',
		enabled: true,
		removable: false,
	},
	{
		...
		label: 'ISO date with bare time (YYYY-MM-DD HHMM)',
		enabled: true,
		removable: false,
	},
	{
		...
		label: 'ISO date T time (YYYY-MM-DDTHH:MM:SS)',
		enabled: true,
		removable: false,
	},
	{
	...
	},
	{
		...
		label: 'EU date with time (DD.MM.YYYY HH:MM)',
		enabled: true,
		removable: false,
	},
	{
	...
	},
	{
		...
		regex: '(\\d{2}\\.\\d{2}\\.\\d{2})(?!\\d)',
		format: 'DD.MM.YY',
		label: 'EU date 2-digit year (DD.MM.YY)',
		enabled: true,
		removable: false,
	},
	{
		...
		label: 'Compact with time seconds (YYYYMMDD_HHMMSS)',
		enabled: true,
		removable: false,
	},
	{
		...
		label: 'Compact with time minutes (YYYYMMDD_HHMM)',
		enabled: true,
		removable: false,
	},
	{
		...
		label: 'Compact dash time (YYYYMMDD-HHMMSS)',
		enabled: true,
		removable: false,
	},
	{
	...
	},
	{
		...
		regex: '(\\d{6})(?!\\d)',
		format: 'YYMMDD',
		label: 'Compact 2-digit year (YYMMDD)',
		enabled: true,
		removable: false,
	},
	{
	...
	},
	{
		...
		format: 'DD-MMM-YYYY',
		label: 'Military style (DD-MMM-YYYY)',
		enabled: true,
		removable: false,
	},
	{
		...
		format: 'DD. MMM. YYYY',
		label: 'German dotted (DD. Mon. YYYY)',
		enabled: true,
		removable: false,
	},
	{
		...
		format: 'DD. MMMM YYYY',
		label: 'German full month (DD. Monat YYYY)',
		enabled: true,
		removable: false,
	},
	{
		...
		format: 'MMM DD, YYYY',
		label: 'English text (Month DD, YYYY)',
		enabled: true,
		removable: false,
	},
	{
		...
		format: 'DD.MMM.YYYY',
		label: 'German compact (DD.Mon.YYYY)',
		enabled: true,
		removable: false,
	},
];
