/**
 *
 * https://gist.githubusercontent.com/dukedorje/7154ab0601e4f9cc1f337e0010168bf8/raw/9ac113ae10d60b17e5d75e202f6bda05a6a5c636/useLiveQuery.ts
 *
 * Caveats
 ...
 */
export function useLiveQuery<T>(query: DrizzleQuery | undefined | null): UseLiveQueryResult<T> {
	...
	useEffect(() => {
		...
		try {
			...
			unsubscribeRef.current = dbOp.reactiveExecute({
				query: sql,
